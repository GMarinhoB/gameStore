...
CREATE TABLE `orderslines` (
  ...
  PRIMARY KEY (`DocEntry`,`DocLine`),
  KEY `ItemCode` (`ItemCode`),
  CONSTRAINT `orderslines_ibfk_1` FOREIGN KEY (`DocEntry`) REFERENCES `orders` (`DocEntry`),
  CONSTRAINT `orderslines_ibfk_2` FOREIGN KEY (`ItemCode`) REFERENCES `product` (`ItemCode`)
...
-- Dump completed on 2025-07-27 18:23:20
